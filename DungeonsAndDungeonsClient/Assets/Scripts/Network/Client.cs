...
public class Client : MonoBehaviour
{
    ...
    public bool lobbyConnected = false;
    public bool gameConnected = false;
    ...
    public class TCP
    {
        ...
        private void ConnectCallback(IAsyncResult _result)
        {
            ...
            if(Client.instance.gameConnected)
            {
            ...
            if (Client.instance.lobbyConnected)
            {

                ClientSend.PlayerLobbyConnect(Client.instance.globalId, Client.instance.localId);
        ...
        //Process synchronized operations on connection establishment
